                    ...
                    <div class="form-inputs">
                        ...
                        <div class="optional-data">
                            <div class="due-date-container">
                                ...
                                <input type="date" class="new-task-due-date" placeholder="dd/mm/yyyy" value="${taskDueDate}" min="${firstDateOfWeek}" max="${lastDateOfWeek}">
                            </div>
