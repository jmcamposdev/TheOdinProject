...
}`, "",{"version":3,"sources":["webpack://./src/css/task.css"],"names":[],"mappings":"AAAA;IACI,aAAa;IACb,sBAAsB;IACtB,SAAS;IACT,gBAAgB;IAChB,wCAAwC;AAC5C;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,8BAA8B;IAC9B,SAAS;IACT,aAAa;IACb,mBAAmB;IACnB,6CAA6C;IAC7C,eAAe;IACf,iBAAiB;AACrB;AACA;IACI,kCAAkC;AACtC;;AAEA;IACI,aAAa;IACb,UAAU;IACV,mBAAmB;IACnB,mBAAmB;IACnB,SAAS;AACb;;AAEA;IACI,UAAU;AACd;;AAEA;IACI,iBAAiB;IACjB,eAAe;IACf,2BAA2B;IAC3B,gBAAgB;IAChB,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,uBAAuB;IACvB,mBAAmB;AACvB;AACA;IACI,kBAAkB;IAClB,UAAU;IACV,eAAe;IACf,gCAAgC;AACpC;AACA;IACI,qBAAqB;AACzB;AACA;IACI,mBAAmB;IACnB,UAAU;AACd;;AAEA;IACI,2BAA2B;IAC3B,gBAAgB;IAChB,kCAAkC;AACtC;;AAEA;;;;CAIC;AACD;IACI,aAAa;IACb,8BAA8B;IAC9B,WAAW;IACX,SAAS;AACb;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,SAAS;IACT,cAAc;AAClB;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,8BAA8B;AAClC;;AAEA;IACI,WAAW;IACX,YAAY;IACZ,6BAA6B;IAC7B,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,wBAAwB;IACxB,SAAS;AACb;;AAEA;IACI,6BAA6B;IAC7B,YAAY;IACZ,eAAe;IACf,gCAAgC;AACpC;;AAEA;IACI,gCAAgC;IAChC,mBAAmB;AACvB;;AAEA;;IAEI,4BAA4B;AAChC;;AAEA;IACI;QACI,uBAAuB;IAC3B;;IAEA;QACI,yBAAyB;IAC7B;AACJ;;;AAGA;;;;CAIC;;AAED;IACI,aAAa;IACb,mBAAmB;IACnB,SAAS;AACb;;AAEA;IACI,6BAA6B;IAC7B,YAAY;IACZ,aAAa;AACjB;AACA;IACI,aAAa;IACb,mBAAmB;IACnB,SAAS;IACT,mBAAmB;IACnB,iBAAiB;AACrB;;AAEA;IACI,2BAA2B;AAC/B;;AAEA;IACI,eAAe;IACf,eAAe;IACf,gCAAgC;AACpC;;;AAGA,qBAAqB;AACrB;IACI,kBAAkB;IAClB,aAAa;IACb,kBAAkB;AACtB;;AAEA;IACI,uBAAuB;IACvB,SAAS;IACT,kBAAkB;IAClB,eAAe;IACf,YAAY;IACZ,OAAO;IACP,kBAAkB;IAClB,QAAQ;IACR,MAAM;IACN,WAAW;AACf;;AAEA;IACI,2BAA2B;AAC/B;AACA;IACI,mBAAmB;IACnB,aAAa;AACjB;;AAEA;;;;CAIC;;AAED;IACI,aAAa;IACb,SAAS;IACT,WAAW;IACX,UAAU;AACd;;AAEA;IACI,kCAAkC;AACtC;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI;QACI,YAAY;IAChB;AACJ","sourcesContent":[".task-list {\n    display: flex;\n    flex-direction: column;\n    gap: 10px;\n    overflow-y: auto;\n    height: calc(100vh - 72px - 80px - 46px);\n}\n\n.task {\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n    gap: 10px;\n    padding: 10px;\n    border-radius: 10px;\n    transition: background-color 0.2s ease-in-out;\n    cursor: pointer;\n    user-select: none;\n}\n.task:hover {\n    background-color: var(--secondary);\n}\n\n.task-info {\n    display: flex;\n    flex: auto;\n    flex-direction: row;\n    align-items: center;\n    gap: 10px;\n}\n\n.task-title {\n    width: 70%;\n}\n\n.extra-data > p {\n    font-weight: bold;\n    font-size: 12px;\n    background-color: #0000001f;\n    padding: 5px 5px;\n    border-radius: 5px;\n}\n\n.task-delete-container {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n}\n.delete-icon {\n    visibility: hidden;\n    opacity: 0;\n    cursor: pointer;\n    transition: all 0.2s ease-in-out;\n}\n.delete-icon:hover {\n    transform: scale(1.2);\n}\n.task:hover .delete-icon {\n    visibility: visible;\n    opacity: 1;\n}\n\n.new-task {\n    justify-content: flex-start;\n    margin-top: 20px;\n    background-color: var(--secondary);\n}\n\n/**\n *  ------------------------\n *  Task Form\n *  ------------------------\n*/\n.new-task-form {\n    display: flex;\n    justify-content: space-between;\n    width: 100%;\n    gap: 10px;\n}\n\n.form-inputs {\n    display: flex;\n    flex-direction: column;\n    gap: 10px;\n    width: inherit;\n}\n\n.form-inputs input {\n    font-size: 16px;\n}\n\n.new-task-notes {\n    height: -webkit-fill-available;\n}\n\n.new-task-title, .new-task-notes {\n    width: 100%;\n    border: none;\n    background-color: transparent;\n    outline: none;\n}\n\n.form-actions {\n    display: flex;\n    flex-direction: column;\n    justify-content: inherit;\n    gap: 20px;\n}\n\n.new-task-submit, .close-new-task-form {\n    background-color: transparent;\n    border: none;\n    cursor: pointer;\n    transition: all 0.2s ease-in-out;\n}\n\n.new-task-submit > span {\n    background-color: var(--primary);\n    border-radius: 15px;\n}\n\n.new-task-submit:hover > .material-symbols-outlined,\n.close-new-task-form:hover  {\n    animation: rotate .3s linear;\n}\n\n@keyframes rotate {\n    0% {\n        transform: rotate(0deg);\n    }\n\n    100% {\n        transform: rotate(190deg);\n    }\n}\n\n\n/**\n *  ------------------------\n *  Task Details\n *  ------------------------\n*/\n\n.optional-data {\n    display: flex;\n    align-items: center;\n    gap: 10px;\n}\n\n.optional-data input {\n    background-color: transparent;\n    border: none;\n    outline: none;\n}\n.due-date-container, .tags-container {\n    display: flex;\n    align-items: center;\n    gap: 10px;\n    border-radius: 25px;\n    padding: 5px 10px;\n}\n\n.due-date-container:hover, .tags-container:hover {\n    background-color: #0000001f;\n}\n\n.optional-data span {\n    font-size: 20px;\n    cursor: pointer;\n    transition: all 0.2s ease-in-out;\n}\n\n\n/* Date Input Style */\n.new-task-due-date, .new-task-tags {\n    visibility: hidden;\n    display: none;\n    position: relative;\n}\n\n.new-task-due-date::-webkit-calendar-picker-indicator{\n    background: transparent;\n    bottom: 0;\n    color: transparent;\n    cursor: pointer;\n    height: auto;\n    left: 0;\n    position: absolute;\n    right: 0;\n    top: 0;\n    width: auto;\n}\n\n.active-form {\n    background-color: #0000001f;\n}\n.active-form input {\n    visibility: visible;\n    display: flex;\n}\n\n/**\n *  ------------------------\n *  Edit Task\n *  ------------------------\n*/\n\n.edit-task {\n    display: flex;\n    gap: 10px;\n    width: 100%;\n    padding: 0;\n}\n\n.task:has(.edit-task)  {\n    background-color: var(--secondary);\n}\n\n.task:has(.edit-task) .new-task-submit span  {\n    animation: none;\n}\n\n@media screen and (max-width: 768px) {\n    .task-list {\n        height: auto;\n    }\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
